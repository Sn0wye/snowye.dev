export const about = {
  ...
  tagline: 'Código. Sono. Repete.',
  bio: {
    p1: 'Olá, eu sou o <strong>Gabriel Trzimajewski</strong>! Sou um cara autodidata que vive, ama e aprende, escuta muita música, ama programar, viajar e tocar piano. Sempre fui apaixonado por computadores desde criança, e descobri a beleza do JavaScript na <strong><a href="https://rocketseat.com.br" target="_blank" rel="noreferrer">Rocketseat</a></strong> no início de 2020.',
    p2: 'Atualmente sou <strong>Engenheiro de Software</strong> no <a href="https://banco.bradesco" target="_blank" rel="noreferrer">Bradesco</a>, trabalhando no time da Open Platform construindo uma plataforma interna de processamento de logs e observabilidade usada em <strong>escala bancária</strong> para investigação de incidentes e monitoramento de sistemas. Sou do Brasil e fã de carteirinha do <strong>twenty one pilots</strong>.',
  ...
  highlightsList: [
    ...
    'Substituí REST síncrono por <strong>gRPC</strong> em rotas sensíveis a latência, melhorando a latência de cauda entre serviços.',
    'Automatizei CI/CD com GitHub Actions (Docker, ECS, ECR), reduzindo deploys de <strong>15 para 3 minutos</strong>.',
